...
function load_style_script(){
    ...
    wp_enqueue_style('main', get_template_directory_uri() . '/css/fm_main.css');
    wp_enqueue_style('fm_custom', get_template_directory_uri() . '/css/fm_custom.css');


             
    wp_enqueue_script('jquery');
    wp_enqueue_script('fancybox', get_template_directory_uri() . '/js/jquery.fancybox.js');
    wp_enqueue_script('main', get_template_directory_uri() . '/js/fm_main.js');
}
